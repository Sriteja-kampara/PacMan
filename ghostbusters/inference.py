...
class ExactInference(InferenceModule):
  ...
  def observe(self, observation, gameState):
    ...
    # Compute all observation updates to the beliefs
    # This is the first part of HMM - Hidden Markov Model
    ...
    print "UPDATE FOR EVIDENCE: ", self.beliefs
  ...
  def elapseTime(self, gameState):
    ...
    # For each position from all legal positions,get the new position distribution
    # Then update the beliefs over time based on the distribution
    # This is the second part of HMM - Hidden Markov Model
    newBeliefs = util.Counter()
    for eachPosition in self.legalPositions:
        newPosDist = self.getPositionDistribution(self.setGhostPosition(gameState, eachPosition))
        # print newPosDist
        for newPos, prob in newPosDist.items():
            newBeliefs[newPos] += prob * self.beliefs[eachPosition]

    self.beliefs = newBeliefs

    print "UPDATE FOR TIME: ", self.beliefs
